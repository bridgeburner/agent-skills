...
| `aggressive-simplification-review` | Coordinates parallel invariant-driven PR/codebase review through architecture, resilience, boundaries, and evidence lenses |
