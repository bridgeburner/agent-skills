...
19 named layouts for slide presentations. Each layout includes HTML structure, CSS, and content limits. All layouts build on the base CSS in [slide-template.md](slide-template.md).
...
| Layout | Category | Content Limit | When to Use |
|---|---|---|---|
| `title` | Foundation | 12 words max | Opening slide with hero background image |
| `section-divider` | Foundation | 8 words max | Chapter break signaling a topic shift |
| `content` | Foundation | 40-50 words, 4-6 bullets | Standard bullet content, text-heavy slides |
| `statement` | Foundation | 15 words max | Single powerful sentence, typography as visual |
| `end` | Foundation | 12 words max | Closing slide or call-to-action |
| `hero-bottom` | Image-Forward | 20 words max | Full-bleed image with bottom-anchored text |
| `hero-center` | Image-Forward | 12 words max | Full-bleed image with centered frosted-glass text |
| `hero-left` | Image-Forward | 30 words max | Full-bleed image with left-pinned text |
| `split-50-50` | Image-Forward | 30-40 words, 3-5 bullets | Balanced half-image, half-text |
| `split-60-40` | Image-Forward | 25-30 words | Image-dominant split (60% image, 40% text) |
| `split-40-60` | Image-Forward | 40-50 words, up to 5 bullets | Text-dominant split (40% image, 60% text) |
| `image-gallery` | Image-Forward | 8 words heading, 2-4 images | Asymmetric mosaic of 2-4 images |
| `big-number` | Data & Metrics | 10 words + the number | Single huge statistic with label |
| `stats-row` | Data & Metrics | 15-20 words, 2-4 stats | Side-by-side metrics dashboard |
| `comparison` | Data & Metrics | 40-50 words, 3-5 items/col | Two-column before/after or feature comparison |
| `grid-cards` | Structured Content | 60-80 words, max 6 cards | 2x2 or 2x3 icon + title + description cards |
| `timeline` | Structured Content | 50-60 words, 3-5 steps | Horizontal connected step sequence |
| `quote` | Structured Content | 40 words max | Large centered blockquote with attribution |
| `team-grid` | Structured Content | 3-4 members, name + role | Headshots with names and roles |
| `logo-wall` | Structured Content | Heading + 6-12 logos | Partner/client logo grid |
