...
Instructions for converting PowerPoint (.ppt/.pptx) files to HTML slide presentations.
...
## Step 6.4: Image Generation

After style selection, proceed to Phase 3 (Plan Images) to decide which extracted slides would benefit from generated images — in addition to any images extracted from the PPT.

## Step 6.5: Generate HTML

Convert the extracted content into the chosen style, preserving:
- All text content
- All extracted images (referenced from assets folder)
- Generated images (from Phase 4)
- Slide order
